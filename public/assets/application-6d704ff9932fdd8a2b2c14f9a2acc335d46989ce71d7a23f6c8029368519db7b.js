...
(function() {
  $(document).on("page:change", function() {
    return $('#submit_post_button_form').click(function() {
      $('span').text('');
      return $('.form-group').removeClass('has-error');
    });
  });

  $(document).ready(function() {
    return $('.sad-vote').click(function() {
      var postId;
      return postId = $(this).attr('class').match(/\d+/);
    });
  });
...
(function() {
  $(document).ready(function() {
    return $(".cpw").click(function() {
      return $(".edit-password").slideToggle();
    });
  });
